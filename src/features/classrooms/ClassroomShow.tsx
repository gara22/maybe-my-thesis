...
export type BookingParams = Pick<
  Booking,
  "from" | "to" | "classroomId" | "description" | "bookerId"
>;
...
const ClassroomShow = () => {
  ...
  const { mutate: createBooking, isLoading: isCreateLoading } =
    useMutate<BookingParams>(
  ...
  return (
    <>
      <Flex direction="column">
        ...
        <WeekSelector
          startDate={currentWeekStartingDate}
          onDateChange={setCurrentWeekStartingDate}
        />
        <Calendar
          days={days}
...
const WeekSelector = ({
  ...
  return (
    ...
    >
      <ArrowBackIcon
        boxSize="10"
        onClick={() => onDateChange(subtractDays(startDate, 7))}
        cursor="pointer"
      />
